...
\includegraphics[width=0.495\textwidth]{Fig/TMVA/thad_vs_QCD/variables_id_c3.eps}
...
\caption{Zprime mass after the full selection for anaylsis cut-based (left) and anti-QCD tagger based (right), and for the two b-tagging scenarios : direct b-tag (top) and Tag Rate Function (bottom). The generated mass of the signal sample is 10 $\TeV$.}
