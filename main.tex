...
\input{sections/BSM-models}
\input{sections/FCC_workflow}
%\input{sections/physics_model} % useless because of sections/BSM-models
\input{sections/analyses}
\input{sections/compHELHC}
\input{sections/model_discrimination}
