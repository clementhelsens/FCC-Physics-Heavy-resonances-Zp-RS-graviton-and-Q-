...
\begin{figure}[!htb]
  ...
  \caption{Left : Invariant mass for a 6~TeV signal after full event selection in \Zpmumu\ flavour anomaly analysis scenario. Limit versus mass (middle) and luminosity for a $5\sigma$ discovery (right).}
