...
Figure~\ref{figure:leptonicresonances:masses} (left and center) shows the invariant mass for a 30~TeV signal for the $ee$ and $\mu\mu$ channels. The mass resolution is better for the ee channel, as expected. Figure~\ref{figure:leptonicresonances:masses} (right) shows the transverse mass~\footnote{the transverse mass is defined as $m_{T}  =  \sqrt{2\ptZp*\met*(1-cos\Delta\phi(\Zp,\met))} $}
of a 10~TeV signal for the $\tau\tau$ channel.
...
\begin{Figure}
  \centering
  \includegraphics[width=0.30\columnwidth]{\main/Fig/mzp_sel0_nostack_log_ee.eps}
  \includegraphics[width=0.30\columnwidth]{\main/Fig/mzp_sel0_nostack_log_mm.eps}
  \includegraphics[width=0.30\columnwidth]{\main/Fig/mt_finalsel_nostack_log.eps}
...
The discovery potential for high mass resonances decaying to $ee$, $\mu\mu$ and $\tau\tau$ has been studied using as a benchmark the \ZpSSM\ model. The very large centre of mass energy provides a correspondingly large mass reach. For the $ee$ and $\mu\mu$ cases masses up to 42~TeV can be excluded or discovered. Heavy resonance decaying to $\tau$ leptons reconstructed in the hadronic decay mode are more challenging, but we would be able to probe massses up to 18~TeV.
  ...
  \begin{Figure}
  \centering
  \includegraphics[width=0.45\columnwidth]{\main/Fig/lim_Zprime_ll_fcc_v02.eps}
  \includegraphics[width=0.45\columnwidth]{\main/Fig/DiscoveryPotential_ll_comb_rootStyle.eps}
...
\begin{Figure}
  \centering
  \includegraphics[width=0.45\columnwidth]{\main/Fig/lim_Zprime_tautau_fcc_v02.eps}
    \includegraphics[width=0.45\columnwidth]{\main/Fig/DiscoveryPotential_tautau_rootStyle.eps}
